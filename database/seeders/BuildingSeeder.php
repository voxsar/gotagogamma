    ...
    public function run()
    {
        ...
        for ($id=1; $id <= 10; $id++) {
            ...
            DB::table('buildings')->insert([
                [
                    'id' => $id, 'name' => 'Banner Points '.$id, 'base' => 10, 'multiplier' => 118,
        ...
        DB::table('buildings')->insert([
            ['id' => 11, 'name' => 'Donation Collection Points', 'base' => 80, 'multiplier' => 600,
        ...
        for ($id=12; $id <= 13; $id++) {
            DB::table('buildings')->insert([
                ['id' => $id, 'name' => 'One Galle Face Restuarants '.$id - 11, 'base' => 160, 'multiplier' => 620,
        ...
        DB::table('buildings')->insert([
            ['id' => 14, 'name' => 'Food Station 1', 'base' => 180, 'multiplier' => 60,
                'description' => ''
            ],
            ['id' => 15, 'name' => 'Food Station 2', 'base' => 180, 'multiplier' => 60,
                'description' => ''
            ],
            ['id' => 16, 'name' => 'Maliban', 'base' => 200, 'multiplier' => 350,
                'description' => ''
            ],
            ['id' => 17, 'name' => 'University Rally Point 1', 'base' => 40, 'multiplier' => 215,
            ...
            ['id' => 18, 'name' => 'University Rally Point 2', 'base' => 40, 'multiplier' => 215,
                'description' => 'University are representation not the just of scholars but also the youth demographic, there has been a long since despise of the youth in Sri Lanka, typically cast aside as violent or destructive, they play a key role in protests as they have both the time, energy and passion to carry out the protests.
                In times of attacks these people are the most vulnerable and therefore will respond in kind when threatened. A saturation of the youth can also give way for the government to shutdown the protests calling it a juvenile attempt, it is important maintain a good protestor diversity'
            ],
            ['id' => 19, 'name' => 'Rally Point', 'base' => 260, 'multiplier' => 230,
                'description' => ''
            ],
            ['id' => 20, 'name' => 'Lawyers Tent', 'base' => 120, 'multiplier' => 323,
                'description' => ''
            ],
        ]);
        ...
        for ($id=21; $id <= 26; $id++) {
            DB::table('buildings')->insert([
                ['id' => $id, 'name' => 'Tent '.$id - 20, 'base' => 180, 'multiplier' => 560,
                    'description' => ''
                ],
            ]);
        }
        ...
        DB::table('buildings')->insert([
            ['id' => 27, 'name' => 'Library', 'base' => 380, 'multiplier' => 810,
                'description' => ''
            ],
            ['id' => 28, 'name' => 'Red Cross', 'base' => 200, 'multiplier' => 1030,
                'description' => ''
            ],
        ]);
        ...
        for ($id=29; $id <= 35; $id++) {
            DB::table('buildings')->insert([
                ['id' => $id, 'name' => 'Small Vendor '.$id, 'base' => 120, 'multiplier' => 58,
                    'description' => ''
                ],
            ]);
        }
        ...
        for ($id=36; $id <= 40; $id++) {
            DB::table('buildings')->insert([
                ['id' => $id, 'name' => 'Large Vendor '.$id, 'base' => 480, 'multiplier' => 23,
                    'description' => ''
                ],
            ]);
        }
