...
class BuildingSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('buildings')->insert([
            [
                'id' => 1, 'name' => 'Banner Points 1', 'base' => 10, 'multiplier' => 118, 'cost_building_class' => '1', "lat" => 6.92959195756671, "lng" => 79.84256313396153, "image_url" => "images/icons/banner.png",
        ...
        DB::table('buildings')->insert([
            [
                'id' => 2, 'name' => 'Banner Points 2', 'base' => 10, 'multiplier' => 118, 'cost_building_class' => '1', "lat" => 6.9294002491821045, "lng" => 79.84263555360494, "image_url" => "images/icons/banner.png",
                'description' => 'Banners are easy to setup, they show the message and wants of the protestors, what the objective of the GotaGoGama should be. You put any banners in the place where banner slots are available as you want and each one will generate loyalty points.
                <br/>
                Banners messages are subjective and can create feelings of disagreement, which create negative points, but banners create more positive points to offset the negative points. They build loyalty when visitors who come read the messages, and when PR photos take these messages into the media both locally and internationally'
            ],
        ...
        DB::table('buildings')->insert([
            [
                'id' => 3, 'name' => 'Banner Points 3', 'base' => 10, 'multiplier' => 118, 'cost_building_class' => '1', "lat" => 6.92918723977444, "lng" => 79.84270529103932, "image_url" => "images/icons/banner.png",
                'description' => 'Banners are easy to setup, they show the message and wants of the protestors, what the objective of the GotaGoGama should be. You put any banners in the place where banner slots are available as you want and each one will generate loyalty points.
                <br/>
                Banners messages are subjective and can create feelings of disagreement, which create negative points, but banners create more positive points to offset the negative points. They build loyalty when visitors who come read the messages, and when PR photos take these messages into the media both locally and internationally'
            ],
        ...
        DB::table('buildings')->insert([
            [
                'id' => 4, 'name' => 'Banner Points 4', 'base' => 10, 'multiplier' => 118, 'cost_building_class' => '1', "lat" => 6.928979555509304, "lng" => 79.84277502847371, "image_url" => "images/icons/banner.png",
                'description' => 'Banners are easy to setup, they show the message and wants of the protestors, what the objective of the GotaGoGama should be. You put any banners in the place where banner slots are available as you want and each one will generate loyalty points.
                <br/>
                Banners messages are subjective and can create feelings of disagreement, which create negative points, but banners create more positive points to offset the negative points. They build loyalty when visitors who come read the messages, and when PR photos take these messages into the media both locally and internationally'
            ],
        ...
        DB::table('buildings')->insert([
            [
                'id' => 5, 'name' => 'Banner Points 5', 'base' => 10, 'multiplier' => 118, 'cost_building_class' => '1', "lat" => 6.928790509496121, "lng" => 79.8428447659081, "image_url" => "images/icons/banner.png",
                'description' => 'Banners are easy to setup, they show the message and wants of the protestors, what the objective of the GotaGoGama should be. You put any banners in the place where banner slots are available as you want and each one will generate loyalty points.
                <br/>
                Banners messages are subjective and can create feelings of disagreement, which create negative points, but banners create more positive points to offset the negative points. They build loyalty when visitors who come read the messages, and when PR photos take these messages into the media both locally and internationally'
            ],
        ...
        DB::table('buildings')->insert([
            [
                'id' => 6, 'name' => 'Banner Points 6', 'base' => 10, 'multiplier' => 118, 'cost_building_class' => '1', "lat" => 6.928553536217606, "lng" => 79.84291182113347, "image_url" => "images/icons/banner.png",
                'description' => 'Banners are easy to setup, they show the message and wants of the protestors, what the objective of the GotaGoGama should be. You put any banners in the place where banner slots are available as you want and each one will generate loyalty points.
                <br/>
                Banners messages are subjective and can create feelings of disagreement, which create negative points, but banners create more positive points to offset the negative points. They build loyalty when visitors who come read the messages, and when PR photos take these messages into the media both locally and internationally'
            ],
        ...
        DB::table('buildings')->insert([
            [
                'id' => 7, 'name' => 'Banner Points 7', 'base' => 10, 'multiplier' => 118, 'cost_building_class' => '1', "lat" => 6.928329875935379, "lng" => 79.8429708297318, "image_url" => "images/icons/banner.png",
                'description' => 'Banners are easy to setup, they show the message and wants of the protestors, what the objective of the GotaGoGama should be. You put any banners in the place where banner slots are available as you want and each one will generate loyalty points.
                <br/>
                Banners messages are subjective and can create feelings of disagreement, which create negative points, but banners create more positive points to offset the negative points. They build loyalty when visitors who come read the messages, and when PR photos take these messages into the media both locally and internationally'
            ],
        ...
        DB::table('buildings')->insert([
            [
                'id' => 8, 'name' => 'Banner Points 8', 'base' => 10, 'multiplier' => 118, 'cost_building_class' => '1', "lat" => 6.927597654031101, "lng" => 79.84415368390736, "image_url" => "images/icons/banner.png",
                'description' => 'Banners are easy to setup, they show the message and wants of the protestors, what the objective of the GotaGoGama should be. You put any banners in the place where banner slots are available as you want and each one will generate loyalty points.
                <br/>
                Banners messages are subjective and can create feelings of disagreement, which create negative points, but banners create more positive points to offset the negative points. They build loyalty when visitors who come read the messages, and when PR photos take these messages into the media both locally and internationally'
            ],
        ...
        DB::table('buildings')->insert([
            [
                'id' => 9, 'name' => 'Banner Points 9', 'base' => 10, 'multiplier' => 118, 'cost_building_class' => '1', "lat" => 6.929178706489036, "lng" => 79.84408931089101, "image_url" => "images/icons/banner.png",
                'description' => 'Banners are easy to setup, they show the message and wants of the protestors, what the objective of the GotaGoGama should be. You put any banners in the place where banner slots are available as you want and each one will generate loyalty points.
                <br/>
                Banners messages are subjective and can create feelings of disagreement, which create negative points, but banners create more positive points to offset the negative points. They build loyalty when visitors who come read the messages, and when PR photos take these messages into the media both locally and internationally'
            ],
        ...
        DB::table('buildings')->insert([
            [
                'id' => 10, 'name' => 'Banner Points 10', 'base' => 10, 'multiplier' => 118, 'cost_building_class' => '1', "lat" => 6.929415679453313, "lng" => 79.84360651326833, "image_url" => "images/icons/banner.png",
                'description' => 'Banners are easy to setup, they show the message and wants of the protestors, what the objective of the GotaGoGama should be. You put any banners in the place where banner slots are available as you want and each one will generate loyalty points.
                <br/>
                Banners messages are subjective and can create feelings of disagreement, which create negative points, but banners create more positive points to offset the negative points. They build loyalty when visitors who come read the messages, and when PR photos take these messages into the media both locally and internationally'
            ],
        ...
        DB::table('buildings')->insert([
            [
                'id' => 11, 'name' => 'Donation Collection Points', 'base' => 80, 'multiplier' => 600, 'cost_building_class' => '2', "lat" => 6.9287592092652375, "lng" => 79.84323279010684, "image_url" => "images/icons/banner.png",
